...
export const MEDICATIONS = [
  ...
  // === GI เพิ่มเติม ===
  { name: 'Gaviscon', generic: 'Sodium alginate + NaHCO3', category: 'Other',
    dosage: '10-20 mL after meals + hs; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Dimenhydrinate', generic: 'Dimenhydrinate', category: 'Other',
    dosage: '50 mg q4-6h; max 300 mg/day; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Simethicone', generic: 'Simethicone', category: 'Other',
    dosage: '40-125 mg QID pc + hs; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Sucralfate', generic: 'Sucralfate', category: 'Other',
    dosage: '1 g QID ac + hs; CKD: avoid long-term (Al accumulation)', source: 'AI-seed', verified: false },
  { name: 'Bismuth subsalicylate', generic: 'Bismuth subsalicylate', category: 'Other',
    dosage: '524 mg q30-60min prn; max 8 doses/day; avoid in CKD', source: 'AI-seed', verified: false },
  { name: 'Antacid (Al/Mg)', generic: 'Aluminium/Magnesium hydroxide', category: 'Other',
    dosage: '10-20 mL q4-6h prn; CKD: avoid Mg-containing', source: 'AI-seed', verified: false },
  { name: 'Milk of Magnesia', generic: 'Magnesium hydroxide', category: 'Other',
    dosage: '30-60 mL prn constipation; avoid in CKD (Mg accumulation)', source: 'AI-seed', verified: false },
  { name: 'Sennoside', generic: 'Sennoside', category: 'Other',
    dosage: '12-24 mg hs; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Bisacodyl', generic: 'Bisacodyl', category: 'Other',
    dosage: '5-10 mg PO hs or 10 mg PR; no renal adj', source: 'AI-seed', verified: false },

  // === Supplements / Vitamins ===
  { name: 'Calcium + Vitamin D', generic: 'Calcium carbonate + Cholecalciferol', category: 'Other',
    dosage: '500-600 mg Ca + 400-800 IU D3 OD-BD', source: 'AI-seed', verified: false },
  { name: 'B-complex', generic: 'Vitamin B complex', category: 'Other',
    dosage: '1-2 tabs OD; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Zinc', generic: 'Zinc sulfate', category: 'Other',
    dosage: '20-40 mg elemental Zn OD; diarrhea: 20 mg OD × 10-14 days', source: 'AI-seed', verified: false },
  { name: 'Vitamin C', generic: 'Ascorbic acid', category: 'Other',
    dosage: '250-500 mg OD-BD; CKD: avoid high dose (oxalate)', source: 'AI-seed', verified: false },
  { name: 'KCl', generic: 'Potassium chloride', category: 'Other',
    dosage: '20-40 mEq/day div BD-TID; monitor K closely in CKD', source: 'AI-seed', verified: false },
  { name: 'Magnesium oxide', generic: 'Magnesium oxide', category: 'Other',
    dosage: '400-800 mg OD; CKD: avoid (Mg accumulation)', source: 'AI-seed', verified: false },

  // === ENT / ตา ===
  { name: 'Pseudoephedrine', generic: 'Pseudoephedrine', category: 'Other',
    dosage: '60 mg q4-6h; no renal adj; avoid in uncontrolled HTN', source: 'AI-seed', verified: false },
  { name: 'Oxymetazoline', generic: 'Oxymetazoline nasal', category: 'Other',
    dosage: '2-3 sprays each nostril BD; max 3 days (rebound congestion)', source: 'AI-seed', verified: false },
  { name: 'Fluticasone nasal', generic: 'Fluticasone propionate nasal', category: 'Resp',
    dosage: '1-2 sprays each nostril OD; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Mometasone nasal', generic: 'Mometasone furoate nasal', category: 'Resp',
    dosage: '2 sprays each nostril OD; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Chloramphenicol eye', generic: 'Chloramphenicol ophthalmic', category: 'Other',
    dosage: '1 drop q2-4h × 5-7 days; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Timolol eye', generic: 'Timolol ophthalmic', category: 'Other',
    dosage: '1 drop BD; caution in asthma/bradycardia', source: 'AI-seed', verified: false },
  { name: 'Latanoprost', generic: 'Latanoprost', category: 'Other',
    dosage: '1 drop hs; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Ciprofloxacin eye', generic: 'Ciprofloxacin ophthalmic', category: 'Other',
    dosage: '1-2 drops q2-4h × 7 days; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Artificial tears', generic: 'Carboxymethylcellulose', category: 'Other',
    dosage: '1-2 drops prn; no renal adj', source: 'AI-seed', verified: false },

  // === ผิวหนัง / Dermatology ===
  { name: 'Acyclovir', generic: 'Acyclovir', category: 'Other',
    dosage: 'Herpes: 400 mg TID × 5d; Zoster: 800 mg 5x/d × 7d; CrCl<25: reduce dose', source: 'AI-seed', verified: false },
  { name: 'Valacyclovir', generic: 'Valacyclovir', category: 'Other',
    dosage: 'Herpes: 500 mg BD × 3d; Zoster: 1 g TID × 7d; CrCl<30: reduce dose', source: 'AI-seed', verified: false },
  { name: 'Ketoconazole', generic: 'Ketoconazole', category: 'Other',
    dosage: 'PO: 200 mg OD (hepatotoxic); topical: cream/shampoo BD', source: 'AI-seed', verified: false },
  { name: 'Clotrimazole', generic: 'Clotrimazole', category: 'Other',
    dosage: 'Topical cream BD × 2-4 wk; vaginal tab 100 mg hs × 7d', source: 'AI-seed', verified: false },
  { name: 'Terbinafine', generic: 'Terbinafine', category: 'Other',
    dosage: 'Topical: BD × 1-2 wk; PO: 250 mg OD × 6-12 wk (onychomycosis); CrCl<50: 50% dose PO', source: 'AI-seed', verified: false },
  { name: 'Itraconazole', generic: 'Itraconazole', category: 'Other',
    dosage: '100-200 mg OD-BD; no renal adj PO; avoid IV if CrCl<30 (cyclodextrin)', source: 'AI-seed', verified: false },
  { name: 'Nystatin', generic: 'Nystatin', category: 'Other',
    dosage: 'Oral thrush: 400,000-600,000 U swish QID; vaginal: 100,000 U tab hs × 14d', source: 'AI-seed', verified: false },
  { name: 'Mupirocin', generic: 'Mupirocin', category: 'Other',
    dosage: 'Topical oint TID × 5-10d; nasal: BD × 5d (MRSA decolonization)', source: 'AI-seed', verified: false },
  { name: 'Fusidic acid', generic: 'Fusidic acid', category: 'Other',
    dosage: 'Topical cream BD-TID × 7d; PO: 500 mg TID', source: 'AI-seed', verified: false },
  { name: 'Silver sulfadiazine', generic: 'Silver sulfadiazine', category: 'Other',
    dosage: 'Burn cream: apply OD-BD; avoid if sulfa allergy', source: 'AI-seed', verified: false },
  { name: 'Permethrin', generic: 'Permethrin', category: 'Other',
    dosage: '5% cream: apply whole body hs, wash off 8-14h; repeat 1 wk', source: 'AI-seed', verified: false },
  { name: 'Hydrocortisone cream', generic: 'Hydrocortisone topical', category: 'Other',
    dosage: '1% cream BD-TID; low-potency; safe for face/folds short-term', source: 'AI-seed', verified: false },
  { name: 'Betamethasone cream', generic: 'Betamethasone valerate topical', category: 'Other',
    dosage: '0.1% cream BD; potent steroid; avoid face/folds; max 2 wk', source: 'AI-seed', verified: false },
  { name: 'Clobetasol cream', generic: 'Clobetasol propionate topical', category: 'Other',
    dosage: '0.05% cream BD; super-potent; max 2 wk; avoid face', source: 'AI-seed', verified: false },
  { name: 'Calamine lotion', generic: 'Calamine + ZnO', category: 'Other',
    dosage: 'Apply prn for itch/rash; no renal adj', source: 'AI-seed', verified: false },

  // === Antiviral เพิ่ม ===
  { name: 'Oseltamivir', generic: 'Oseltamivir', category: 'Other',
    dosage: '75 mg BD × 5d; CrCl 10-30: 75 mg OD; HD: 30 mg post-HD', source: 'AI-seed', verified: false },
  { name: 'Favipiravir', generic: 'Favipiravir', category: 'Other',
    dosage: '1800 mg BD day 1 → 800 mg BD × 5-9d; no renal adj', source: 'AI-seed', verified: false },

  // === Antibiotics เพิ่ม ===
  { name: 'Fosfomycin', generic: 'Fosfomycin', category: 'Other',
    dosage: 'UTI: 3 g PO single dose; CrCl<10: avoid PO form', source: 'AI-seed', verified: false },
  { name: 'Cefixime', generic: 'Cefixime', category: 'Other',
    dosage: '200 mg BD or 400 mg OD; CrCl<20: 50% dose', source: 'AI-seed', verified: false },
  { name: 'Norfloxacin', generic: 'Norfloxacin', category: 'Other',
    dosage: '400 mg BD; CrCl<30: 400 mg OD; UTI prophylaxis', source: 'AI-seed', verified: false },
  { name: 'Gentamicin', generic: 'Gentamicin', category: 'Other',
    dosage: '5-7 mg/kg IV OD; CKD: extend interval; HD: redose post-HD per level', source: 'AI-seed', verified: false, riskClass: 'narrow-ti' },
  { name: 'Colistin', generic: 'Colistimethate sodium', category: 'Other',
    dosage: 'Load 9 MU → 4.5 MU BD; CKD: dose per CrCl; HD: supplement', source: 'AI-seed', verified: false, riskClass: 'narrow-ti' },
  { name: 'Amphotericin B', generic: 'Amphotericin B', category: 'Other',
    dosage: 'Conventional: 0.5-1 mg/kg/d IV; liposomal: 3-5 mg/kg/d; nephrotoxic — monitor Cr/K/Mg', source: 'AI-seed', verified: false },
  { name: 'Cotrimoxazole prophylaxis', generic: 'TMP-SMX low dose', category: 'Other',
    dosage: 'PCP prophylaxis: SS tab OD or DS 3x/wk; CrCl<15: avoid', source: 'AI-seed', verified: false },

  // === Urology ===
  { name: 'Tamsulosin', generic: 'Tamsulosin', category: 'Other',
    dosage: '0.4 mg OD pc; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Silodosin', generic: 'Silodosin', category: 'Other',
    dosage: '4-8 mg OD; CrCl<30: 4 mg OD', source: 'AI-seed', verified: false },
  { name: 'Finasteride', generic: 'Finasteride', category: 'Other',
    dosage: 'BPH: 5 mg OD; hair loss: 1 mg OD; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Dutasteride', generic: 'Dutasteride', category: 'Other',
    dosage: '0.5 mg OD; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Oxybutynin', generic: 'Oxybutynin', category: 'Other',
    dosage: '5 mg BD-TID; CKD: start 2.5 mg BD; anticholinergic SEs', source: 'AI-seed', verified: false },
  { name: 'Potassium citrate', generic: 'Potassium citrate', category: 'Other',
    dosage: '15-30 mEq TID; for RTA/uric acid stones; monitor K in CKD', source: 'AI-seed', verified: false },
  { name: 'Sildenafil', generic: 'Sildenafil', category: 'Other',
    dosage: 'ED: 25-100 mg prn; PAH: 20 mg TID; no renal adj', source: 'AI-seed', verified: false },

  // === Rheumatology ===
  { name: 'Methotrexate', generic: 'Methotrexate', category: 'Other',
    dosage: 'RA: 7.5-25 mg PO/SC weekly + folic acid; CrCl<30: avoid', source: 'AI-seed', verified: false },
  { name: 'Hydroxychloroquine', generic: 'Hydroxychloroquine', category: 'Other',
    dosage: '200-400 mg OD; CKD: no adj needed; eye exam yearly', source: 'AI-seed', verified: false },
  { name: 'Sulfasalazine', generic: 'Sulfasalazine', category: 'Other',
    dosage: '500 mg BD → 1 g BD; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Azathioprine', generic: 'Azathioprine', category: 'Other',
    dosage: '1-2.5 mg/kg/day; no renal adj but monitor CBC closely', source: 'AI-seed', verified: false },
  { name: 'Mycophenolate', generic: 'Mycophenolate mofetil', category: 'Other',
    dosage: '500-1000 mg BD; CKD: max 2 g/day; monitor CBC', source: 'AI-seed', verified: false },
  { name: 'Cyclosporine', generic: 'Cyclosporine', category: 'Other',
    dosage: '2-5 mg/kg/day div BD; nephrotoxic — monitor level + Cr', source: 'AI-seed', verified: false, riskClass: 'narrow-ti' },
  { name: 'Tacrolimus', generic: 'Tacrolimus', category: 'Other',
    dosage: '0.05-0.15 mg/kg/day div BD; target level 5-10 ng/mL; nephrotoxic', source: 'AI-seed', verified: false, riskClass: 'narrow-ti' },

  // === Cardiac เพิ่ม ===
  { name: 'Ivabradine', generic: 'Ivabradine', category: 'CV',
    dosage: '5 mg BD → 7.5 mg BD; no renal adj; target HR 50-60', source: 'AI-seed', verified: false },
  { name: 'Sacubitril/Valsartan', generic: 'Sacubitril + Valsartan', category: 'CV',
    dosage: '24/26 mg BD → titrate to 97/103 mg BD; eGFR<30: start low', source: 'AI-seed', verified: false },
  { name: 'Nitroglycerin', generic: 'Glyceryl trinitrate', category: 'CV',
    dosage: 'SL 0.4 mg prn angina; patch 0.2-0.8 mg/hr; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Dobutamine', generic: 'Dobutamine', category: 'CV',
    dosage: '2-20 mcg/kg/min IV; no renal adj', source: 'AI-seed', verified: false },
  { name: 'Dopamine', generic: 'Dopamine', category: 'CV',
...
export const BRAND_MAP = {
  ...
  // Phase 4 brands
  'Gaviscon': ['Gaviscon', 'กาวิสคอน', 'Sodium alginate'],
  'Dimenhydrinate': ['Dramamine', 'Dimen', 'ไดเมน'],
  'Simethicone': ['Air-X', 'Gas-X', 'Flatulex'],
  'Sucralfate': ['Ulcerguard', 'Carafate'],
  'Antacid (Al/Mg)': ['Maalox', 'Mylanta', 'Gelusil'],
  'Milk of Magnesia': ['MOM', 'Phillips'],
  'Sennoside': ['Senokot', 'Pursennid'],
  'Bisacodyl': ['Dulcolax', 'Ducolax'],
  'Pseudoephedrine': ['Sudafed', 'Actifed'],
  'Oxymetazoline': ['Iliadin', 'Afrin'],
  'Fluticasone nasal': ['Flixonase', 'Avamys'],
  'Mometasone nasal': ['Nasonex'],
  'Chloramphenicol eye': ['Chloroph'],
  'Timolol eye': ['Timoptic'],
  'Latanoprost': ['Xalatan'],
  'Artificial tears': ['Refresh', 'น้ำตาเทียม', 'Tears Natural'],
  'Acyclovir': ['Zovirax', 'Acyvir'],
  'Valacyclovir': ['Valtrex'],
  'Ketoconazole': ['Nizoral'],
  'Clotrimazole': ['Canesten', 'Candid'],
  'Terbinafine': ['Lamisil'],
  'Itraconazole': ['Sporanox', 'Itra'],
  'Nystatin': ['Mycostatin'],
  'Mupirocin': ['Bactroban'],
  'Fusidic acid': ['Fucidin'],
  'Permethrin': ['Elimite', 'Lyclear'],
  'Hydrocortisone cream': ['HC cream', 'ครีม HC'],
  'Betamethasone cream': ['Diprosone', 'Celestoderm'],
  ...
  'Tamsulosin': ['Harnal', 'Flomax'],
  'Silodosin': ['Urief'],
  'Finasteride': ['Proscar', 'Propecia'],
  'Dutasteride': ['Avodart'],
  'Oxybutynin': ['Ditropan'],
  'Sildenafil': ['Viagra', 'Revatio', 'Sidegra'],
  ...
  'Tacrolimus': ['Prograf', 'FK506', 'Advagraf'],
  'Ivabradine': ['Procoralan', 'Coralan'],
  'Sacubitril/Valsartan': ['Entresto', 'ARNI'],
  'Nitroglycerin': ['NTG', 'GTN'],
  'Dobutamine': ['Dobutrex'],
  'Norepinephrine': ['Levophed', 'NE'],
  'Risperidone': ['Risperdal'],
  'Olanzapine': ['Zyprexa'],
  'Lithium': ['Lithium', 'Eskalith'],
  ...
  'Morphine': ['MST', 'MS Contin'],
  'Fentanyl': ['Durogesic', 'Fentanyl patch'],
  'TDF/FTC': ['Truvada', 'TDF'],
  'TAF/FTC': ['Descovy', 'TAF'],
  'Dolutegravir': ['Tivicay', 'DTG'],
  'Efavirenz': ['Stocrin', 'EFV'],
  'Isoniazid': ['INH', 'Nydrazid'],
  'Rifampicin': ['Rifadin', 'RIF'],
  'Pyrazinamide': ['PZA'],
  'Ethambutol': ['EMB', 'Myambutol'],
  'Testosterone': ['Nebido', 'Androgel'],
  'Raloxifene': ['Evista'],
