...
export default function DrAIFloat({ settings }) {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: scroll on any chat state change
  useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-gray-50">
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-4 py-3 space-y-3">
        ...
        {messages.map((msg, i) => (
          // biome-ignore lint/suspicious/noArrayIndexKey: chat messages lack stable IDs
