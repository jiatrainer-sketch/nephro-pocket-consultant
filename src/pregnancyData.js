...
const D = {
  ...
  'Gaviscon': { p: 'safe', pN: 'First-line for GERD in pregnancy', pAlt: [], l: 'safe', lN: 'Not absorbed; safe', ind: ['GERD'] },
  'Dimenhydrinate': { p: 'safe', pN: 'Used for NVP; long experience', pAlt: [], l: 'caution', lN: 'May reduce milk supply', ind: ['nausea'] },
  'Simethicone': { p: 'safe', pN: 'Not absorbed; safe', pAlt: [], l: 'safe', lN: 'Safe', ind: ['abdominal-pain'] },
  'Sucralfate': { p: 'safe', pN: 'Not absorbed; safe', pAlt: [], l: 'safe', lN: 'Safe', ind: ['GERD', 'abdominal-pain'] },
  'Bismuth subsalicylate': { p: 'avoid', pN: 'Salicylate component; bismuth absorption', pAlt: ['Gaviscon', 'Sucralfate'], l: 'avoid', lN: 'Salicylate in milk', ind: ['diarrhea'] },
  'Antacid (Al/Mg)': { p: 'safe', pN: 'Safe short-term; avoid excessive Mg', pAlt: [], l: 'safe', lN: 'Safe', ind: ['GERD'] },
  'Milk of Magnesia': { p: 'safe', pN: 'Safe for constipation', pAlt: [], l: 'safe', lN: 'Safe', ind: ['constipation'] },
  'Sennoside': { p: 'safe', pN: 'Preferred stimulant laxative in pregnancy', pAlt: [], l: 'safe', lN: 'Not excreted in milk', ind: ['constipation'] },
  'Bisacodyl': { p: 'caution', pN: 'OK short-term; lactulose preferred', pAlt: ['Lactulose', 'Sennoside'], l: 'safe', lN: 'Compatible', ind: ['constipation'] },
  'Calcium + Vitamin D': { p: 'safe', pN: 'Recommended in pregnancy', pAlt: [], l: 'safe', lN: 'Safe', ind: [] },
  'B-complex': { p: 'safe', pN: 'Safe supplement', pAlt: [], l: 'safe', lN: 'Safe', ind: [] },
  'Zinc': { p: 'safe', pN: 'Safe at recommended doses', pAlt: [], l: 'safe', lN: 'Safe', ind: ['diarrhea'] },
  'Vitamin C': { p: 'safe', pN: 'Safe at ≤1000 mg/day', pAlt: [], l: 'safe', lN: 'Safe', ind: [] },
  'KCl': { p: 'safe', pN: 'Safe if indicated', pAlt: [], l: 'safe', lN: 'Safe', ind: [] },
  'Magnesium oxide': { p: 'safe', pN: 'Safe as supplement', pAlt: [], l: 'safe', lN: 'Safe', ind: ['constipation'] },
  'Pseudoephedrine': { p: 'caution', pN: 'Avoid 1st tri (gastroschisis risk debated); OK 2nd/3rd short-term', pAlt: ['Oxymetazoline'], l: 'caution', lN: 'May reduce milk supply', ind: ['nasal-congestion'] },
  'Oxymetazoline': { p: 'safe', pN: 'Topical; minimal systemic; preferred decongestant in pregnancy', pAlt: [], l: 'safe', lN: 'Topical; safe', ind: ['nasal-congestion'] },
  'Fluticasone nasal': { p: 'safe', pN: 'Preferred intranasal steroid in pregnancy', pAlt: [], l: 'safe', lN: 'Minimal systemic', ind: ['nasal-congestion'] },
  'Mometasone nasal': { p: 'safe', pN: 'Compatible', pAlt: [], l: 'safe', lN: 'Minimal systemic', ind: ['nasal-congestion'] },
  'Chloramphenicol eye': { p: 'safe', pN: 'Topical; minimal absorption', pAlt: [], l: 'safe', lN: 'Safe topical', ind: [] },
  'Timolol eye': { p: 'caution', pN: 'Beta-blocker; potential fetal effects', pAlt: [], l: 'caution', lN: 'Excreted in milk', ind: [] },
  'Latanoprost': { p: 'avoid', pN: 'Prostaglandin; uterine contraction risk', pAlt: ['Timolol eye'], l: 'caution', lN: 'Unknown', ind: [] },
  'Ciprofloxacin eye': { p: 'safe', pN: 'Topical; minimal absorption', pAlt: [], l: 'safe', lN: 'Safe topical', ind: [] },
  'Artificial tears': { p: 'safe', pN: 'Safe', pAlt: [], l: 'safe', lN: 'Safe', ind: [] },
  'Acyclovir': { p: 'safe', pN: 'Extensive data; safe all trimesters', pAlt: [], l: 'safe', lN: 'Low levels; compatible', ind: [] },
  'Valacyclovir': { p: 'safe', pN: 'Prodrug of acyclovir; same safety', pAlt: [], l: 'safe', lN: 'Compatible', ind: [] },
  'Ketoconazole': { p: 'avoid', pN: 'Teratogenic PO; topical OK', pAlt: ['Clotrimazole'], l: 'safe', lN: 'Topical OK; PO avoid', ind: [] },
  'Clotrimazole': { p: 'safe', pN: 'Preferred antifungal in pregnancy (topical/vaginal)', pAlt: [], l: 'safe', lN: 'Topical; safe', ind: [] },
  'Terbinafine': { p: 'avoid', pN: 'Defer treatment to postpartum', pAlt: ['Clotrimazole'], l: 'caution', lN: 'Excreted in milk', ind: [] },
  'Itraconazole': { p: 'avoid', pN: 'Teratogenic in animals', pAlt: ['Clotrimazole'], l: 'avoid', lN: 'Excreted in milk', ind: [] },
  'Nystatin': { p: 'safe', pN: 'Not absorbed; safe topical/oral', pAlt: [], l: 'safe', lN: 'Safe', ind: [] },
  'Mupirocin': { p: 'safe', pN: 'Topical; minimal absorption', pAlt: [], l: 'safe', lN: 'Safe topical', ind: [] },
  'Fusidic acid': { p: 'caution', pN: 'Topical OK; PO limited data', pAlt: [], l: 'safe', lN: 'Topical safe', ind: [] },
  'Silver sulfadiazine': { p: 'avoid', pN: 'Sulfa; avoid near term (kernicterus)', pAlt: [], l: 'caution', lN: 'Sulfa component', ind: [] },
  'Permethrin': { p: 'safe', pN: 'Preferred scabicide in pregnancy', pAlt: [], l: 'safe', lN: 'Safe', ind: ['rash-allergy'] },
  'Hydrocortisone cream': { p: 'safe', pN: 'Low-potency; safe topical', pAlt: [], l: 'safe', lN: 'Safe', ind: ['rash-allergy'] },
  'Betamethasone cream': { p: 'caution', pN: 'Potent topical; short-term OK', pAlt: ['Hydrocortisone cream'], l: 'caution', lN: 'Avoid nipple area', ind: ['rash-allergy'] },
  'Clobetasol cream': { p: 'caution', pN: 'Super-potent; limit use', pAlt: ['Hydrocortisone cream'], l: 'caution', lN: 'Avoid nipple area', ind: [] },
  'Calamine lotion': { p: 'safe', pN: 'Safe topical', pAlt: [], l: 'safe', lN: 'Safe', ind: ['rash-allergy'] },
  'Oseltamivir': { p: 'safe', pN: 'Recommended for influenza in pregnancy', pAlt: [], l: 'safe', lN: 'Compatible', ind: ['fever', 'cough'] },
  'Favipiravir': { p: 'contraindicated', pN: 'Teratogenic; pregnancy test required before use', pAlt: ['Oseltamivir'], l: 'avoid', lN: 'No data', ind: [] },
  'Fosfomycin': { p: 'safe', pN: 'Safe for UTI in pregnancy', pAlt: [], l: 'safe', lN: 'Compatible', ind: ['UTI'] },
  'Cefixime': { p: 'safe', pN: 'Cephalosporin; safe', pAlt: [], l: 'safe', lN: 'Compatible', ind: ['UTI'] },
  'Norfloxacin': { p: 'avoid', pN: 'Fluoroquinolone; cartilage risk', pAlt: ['Cephalexin', 'Fosfomycin'], l: 'caution', lN: 'Short course OK', ind: ['UTI'] },
  'Gentamicin': { p: 'caution', pN: 'Ototoxic potential; use if needed for serious infection', pAlt: [], l: 'safe', lN: 'Poorly absorbed orally by infant', ind: [] },
  'Colistin': { p: 'caution', pN: 'Limited data; use for MDR infections only', pAlt: [], l: 'caution', lN: 'Unknown', ind: [] },
  'Amphotericin B': { p: 'caution', pN: 'Use if life-threatening fungal infection', pAlt: [], l: 'caution', lN: 'Unknown', ind: [] },
  'Tamsulosin': { p: 'avoid', pN: 'Not indicated in women', pAlt: [], l: 'avoid', lN: 'Not indicated', ind: [] },
  'Finasteride': { p: 'contraindicated', pN: 'Anti-androgen; male fetus feminization; do not handle crushed tabs', pAlt: [], l: 'contraindicated', lN: 'Excreted; risk to male infant', ind: [] },
  'Dutasteride': { p: 'contraindicated', pN: 'Same as finasteride', pAlt: [], l: 'contraindicated', lN: 'Same as finasteride', ind: [] },
  'Oxybutynin': { p: 'caution', pN: 'Limited data', pAlt: [], l: 'caution', lN: 'May reduce milk supply', ind: [] },
  'Sildenafil': { p: 'caution', pN: 'Limited data; used in research for FGR', pAlt: [], l: 'caution', lN: 'Unknown', ind: [] },
  'Methotrexate': { p: 'contraindicated', pN: 'Abortifacient + teratogenic; stop 3 months before conception', pAlt: ['Hydroxychloroquine'], l: 'contraindicated', lN: 'Excreted; immunosuppressive', ind: [] },
  'Hydroxychloroquine': { p: 'safe', pN: 'Safe in SLE pregnancy; continue', pAlt: [], l: 'safe', lN: 'Compatible', ind: [] },
  'Sulfasalazine': { p: 'safe', pN: 'Safe; take folic acid 5 mg', pAlt: [], l: 'safe', lN: 'Compatible; monitor infant jaundice', ind: [] },
  'Azathioprine': { p: 'caution', pN: 'Acceptable in pregnancy if needed for autoimmune disease', pAlt: [], l: 'caution', lN: 'Low levels; monitor infant CBC', ind: [] },
  'Mycophenolate': { p: 'contraindicated', pN: 'Teratogenic; switch to azathioprine before conception', pAlt: ['Azathioprine'], l: 'avoid', lN: 'Unknown', ind: [] },
  'Cyclosporine': { p: 'caution', pN: 'Use if needed for transplant; monitor levels', pAlt: [], l: 'caution', lN: 'Excreted but generally OK', ind: [] },
  'Tacrolimus': { p: 'caution', pN: 'Use if needed for transplant; safer than cyclosporine data', pAlt: [], l: 'caution', lN: 'Low levels; compatible', ind: [] },
  'Ivabradine': { p: 'contraindicated', pN: 'Teratogenic in animals', pAlt: ['Metoprolol'], l: 'avoid', lN: 'No data', ind: [] },
  'Sacubitril/Valsartan': { p: 'contraindicated', pN: 'Contains ARB; fetotoxic', pAlt: ['Hydralazine'], l: 'avoid', lN: 'No data', ind: ['hypertension'] },
  'Nitroglycerin': { p: 'caution', pN: 'Use for acute HTN/tocolysis if needed', pAlt: [], l: 'safe', lN: 'Short half-life', ind: [] },
  'Dobutamine': { p: 'caution', pN: 'Use in emergency', pAlt: [], l: 'caution', lN: 'Unknown', ind: [] },
  'Dopamine': { p: 'caution', pN: 'Use in emergency', pAlt: [], l: 'caution', lN: 'Unknown', ind: [] },
  'Norepinephrine': { p: 'caution', pN: 'Use in emergency; may reduce uterine blood flow', pAlt: [], l: 'caution', lN: 'Short half-life', ind: [] },
  'Risperidone': { p: 'caution', pN: 'Limited data; use if needed', pAlt: [], l: 'caution', lN: 'Low levels', ind: [] },
  'Olanzapine': { p: 'caution', pN: 'Most data among atypicals; GDM risk', pAlt: [], l: 'caution', lN: 'Low levels', ind: [] },
  'Lithium': { p: 'caution', pN: 'Ebstein anomaly risk (lower than thought ~0.1%); level monitoring essential; avoid 1st tri if possible', pAlt: ['Lamotrigine'], l: 'avoid', lN: 'Excreted significantly; infant toxicity risk', ind: [] },
  'Clonazepam': { p: 'avoid', pN: 'Benzo; floppy infant + withdrawal', pAlt: ['Lorazepam'], l: 'caution', lN: 'Low levels; short course OK', ind: [] },
  'Alprazolam': { p: 'avoid', pN: 'Benzo; avoid chronic use', pAlt: [], l: 'caution', lN: 'Low levels', ind: [] },
  'Mirtazapine': { p: 'caution', pN: 'Limited data; sertraline preferred', pAlt: ['Sertraline'], l: 'caution', lN: 'Low levels', ind: ['depression', 'insomnia'] },
  'Trazodone': { p: 'caution', pN: 'Limited data', pAlt: ['Sertraline'], l: 'caution', lN: 'Low levels', ind: ['insomnia'] },
  'Orphenadrine': { p: 'caution', pN: 'Limited data', pAlt: ['Paracetamol'], l: 'caution', lN: 'Unknown', ind: ['back-pain'] },
  'Eperisone': { p: 'avoid', pN: 'No pregnancy data', pAlt: ['Paracetamol'], l: 'avoid', lN: 'No data', ind: ['back-pain'] },
  'Tizanidine': { p: 'avoid', pN: 'Teratogenic in animals', pAlt: ['Paracetamol'], l: 'avoid', lN: 'No data', ind: ['back-pain'] },
  'Capsaicin cream': { p: 'caution', pN: 'Topical; limited data', pAlt: [], l: 'safe', lN: 'Topical; safe', ind: ['back-pain'] },
  'Morphine': { p: 'caution', pN: 'Use if severe pain; neonatal withdrawal if chronic', pAlt: ['Paracetamol'], l: 'caution', lN: 'Low levels at normal doses; monitor infant sedation', ind: [] },
  'Fentanyl': { p: 'caution', pN: 'Short-acting preferred in labor; chronic use → withdrawal', pAlt: ['Paracetamol'], l: 'caution', lN: 'Low levels; compatible short-term', ind: [] },
  'TDF/FTC': { p: 'safe', pN: 'Preferred NRTI backbone in pregnancy', pAlt: [], l: 'safe', lN: 'Compatible; recommended', ind: [] },
  'TAF/FTC': { p: 'safe', pN: 'Less data than TDF but expected safe', pAlt: ['TDF/FTC'], l: 'safe', lN: 'Expected compatible', ind: [] },
  'Dolutegravir': { p: 'safe', pN: 'Preferred INSTI; NTD risk very low (updated data)', pAlt: [], l: 'safe', lN: 'Compatible', ind: [] },
  'Efavirenz': { p: 'safe', pN: 'NTD concern disproven; safe per WHO 2018', pAlt: ['Dolutegravir'], l: 'safe', lN: 'Compatible', ind: [] },
  'Isoniazid': { p: 'safe', pN: 'Safe for TB treatment + prophylaxis; + pyridoxine', pAlt: [], l: 'safe', lN: 'Compatible', ind: [] },
  'Rifampicin': { p: 'safe', pN: 'Safe; vitamin K to neonate (bleeding risk)', pAlt: [], l: 'safe', lN: 'Compatible', ind: [] },
  'Pyrazinamide': { p: 'caution', pN: 'WHO recommends; limited data', pAlt: [], l: 'safe', lN: 'Compatible', ind: [] },
  'Ethambutol': { p: 'safe', pN: 'Safe in pregnancy', pAlt: [], l: 'safe', lN: 'Compatible', ind: [] },
  'Testosterone': { p: 'contraindicated', pN: 'Virilization of female fetus', pAlt: [], l: 'contraindicated', lN: 'Avoid', ind: [] },
  'Estrogen (CEE)': { p: 'contraindicated', pN: 'Not for use in pregnancy', pAlt: [], l: 'avoid', lN: 'Reduces milk supply', ind: [] },
  'Raloxifene': { p: 'contraindicated', pN: 'Teratogenic', pAlt: [], l: 'avoid', lN: 'Unknown', ind: [] },
  'Clomifene': { p: 'contraindicated', pN: 'Discontinue once pregnant', pAlt: [], l: 'avoid', lN: 'May suppress lactation', ind: [] },
  'Lidocaine': { p: 'safe', pN: 'Safe for local/regional anesthesia; dental OK', pAlt: [], l: 'safe', lN: 'Compatible', ind: [] },
  'Bupivacaine': { p: 'safe', pN: 'Standard for epidural/spinal in labor', pAlt: [], l: 'safe', lN: 'Compatible', ind: [] },
}
